...
class PaginationHelper:
  ...
  def __init__(self, collection, items_per_page):
      ...
      self.collection = list(self.split_collection(collection, items_per_page))
      
  def split_collection(self, colle, items):
      for part in range(0, len(colle), items):
          yield colle[part:part+items]
